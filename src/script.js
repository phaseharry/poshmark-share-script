...
const handlePromoDialog = async (driver) => {
  ...
  try {
    ...
    const promotedClosetCloseButton = await driver.findElement(
      By.css('[data-et-on-name="promoted_closet_invite_modal"]'),
    );
...
const share = async (driver) => {
  ...
  try {
    ...
    const shareToFollowersListingsDisplayButton = await userInfo.findElement(
      By.css('[data-et-name="share_to_followers"]'),
    );
